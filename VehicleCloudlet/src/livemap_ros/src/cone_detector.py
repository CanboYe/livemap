...
if __name__ == '__main__':
    prototxt = '/home/cloudlet/ConeDemo/coneDetector1/coneDetector1.pt'
    caffemodel = '/home/cloudlet/ConeDemo/coneDetector1/coneDetector1.caffemodel'
    #im = 'frame425.jpg'

    cpu_mode = False
    gpu_id = 0
    if not os.path.isfile(caffemodel):
        raise IOError(('{:s} not found.\nDid you change the directory with absolute path?').format(caffemodel))
