...
void makeDBConfigFile(const std::string &dbname = DEFAULT_SQL_DB, 
                      const std::string &user = DEFAULT_SQL_USER , 
                      const std::string &password = DEFAULT_SQL_PWD , 
                      const std::string &hostaddr = DEFAULT_SQL_IPA , 
                      const std::string &port = DEFAULT_SQL_PORT);
